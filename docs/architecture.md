...
3. **AI Validation**: Setup candidates are passed to the **Market Intel Engine** where an AI model (GPT-5 or Gemini) checks the list against institutional sentiment rules.
